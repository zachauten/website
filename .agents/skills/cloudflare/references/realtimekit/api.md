...
// Methods
await meeting.self.enableAudio() / disableAudio() / enableVideo()
  / disableVideo() / enableScreenShare() / disableScreenShare();
await meeting.self.setName("Name"); // Before join only
await meeting.self.setDevice(device);
const devices = await meeting.self.getAllDevices() / getAudioDevices()
  / getVideoDevices() / getSpeakerDevices();
