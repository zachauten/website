...
This site is effectively a marketing page for the Triangle DSA (TDSA). The goals are to display information about what we believe, what we're working on, and how people can get involved.

In support of this goal, the site also displays a calendar of events, a blog (Left Angles), a merch page, and a page outlining our endorsement process for prospective electeds seeking an endorsement.
